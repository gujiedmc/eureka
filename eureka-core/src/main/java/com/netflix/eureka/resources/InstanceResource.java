 ...
 * 实例相关操作结构。
 *
 * 1. 查看实例信息 {@link #getInstanceInfo()}
 * 2. 实例心跳续约 {@link #renewLease}
 * 3. 状态更新 {@link #statusUpdate}
 * 4. 取消注册 {@link #cancelLease}
 * 5. 修改实例元数据 {@link #updateMetadata}
 * 6. 删除状态更新 {@link #deleteStatusUpdate}
 *
